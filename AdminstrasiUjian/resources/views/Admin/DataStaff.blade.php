...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    <div class="row">
        <ol class="breadcrumb" style="font-family: Segoe UI">
            ...
            <li class="active">
                <a href="{{ url('/dataStaff/{staff}') }}" class="aBread">Data Staff </a>
            </li>
        </ol>
    </div>
    <div class="col-lg-12" style="display: flex; justify-content: center;background-color: none;">
        <h1 class="mt-5" style="dtransform: translate(-30%);font-family: Segoe UI">Data Staff</h1>
    </div>
...
<div class="col-lg-12">
    <div class="col-sm-10" style="position:absolute;margin-left:auto; margin-right:auto; margin-top:auto; margin-bottom:auto; left:0; right:0; top:10%;">    
        <div class="wrap-table100" style="margin-bottom: 10%">
            <button type="button" class="btn btn-info " data-toggle="modal" data-target="#modalForm" type="button" class="btn btn-primary" style="margin-top: 5%;margin-bottom: 1%;"><span class="fa fa-plus" ></span>  &nbsp;Tambah Staff</button>
            <div class="table100 mt-5">
                <table style="font-family: Sagoe UI">
                    <thead>
                        <tr class="table100-head"  style="font-family: Segoe UI;">
                            <th class="column">#</th>
                            <th class="column">Nama Staff</th>
                    ...
                    <div class="modal-body">
                          <form action="{{ url('/DataPengguna')  }}" method="post">
                              ...
                              <div class="form-group">
                                  ...
                                  <input type="text" name="namaPengguna" class="form-control" id="name" placeholder="Nama Staff">
                              ...
                              <div class="form-group">
                                <label for="password">Password</label>
                                <input type="password" name="confirmation" class="form-control" id="password" placeholder="Confirm Password">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="myModalLabel" style="text-align: left;font-family: Segoe UI;">Edit Staff</h4>
                        </div>
                        <div class="modal-body">
                            <p class="statusMsg"></p>
                            <form role="form" action="{{ url('/updatePengguna') }}" method="post">
                                ...
                                <div class="form-group">                                    
                                    ...
                                    <label for="name">Nama Staff</label>
                                    <input type="text" name="namaPengguna" class="form-control" id="namaPengguna" placeholder="Nama Staff">
                                  </div>
                                <div class="form-group">
                                  <label for="username">Username</label>
                                  <input type="text" name="username" class="form-control" id="username" placeholder="Username">
