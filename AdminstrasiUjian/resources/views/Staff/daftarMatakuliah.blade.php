...
<div class="col-sm-12 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    <div class="row">
        <div class="col-lg-12">
            <ol class="breadcrumb" style="font-family: Segoe UI">
                ...
                <li class="active">
                    <a href="{{ url('/daftarHadir') }}" class="aBread"> Daftar Hadir </a>
                </li>
                <li class="active">
    ...
    <div class="col-lg-11" style="margin-top: 1%" >
        <form action="{{ url('/DaftarHadir/cetak_allDaftarhadir') }}"  method="POST">
            @csrf
                <input name="prodi" type="hidden" value="{{ $nama_prodi->id }}">
        
       
    </form>

    </div>
    <div class="col-sm-10" style="position:absolute;margin-left:auto; margin-right:auto; margin-top:auto; margin-bottom:auto; left:0; right:0;margin-top: 10%; ">    
        @if($errors->has('radio'))
        ...
        <div class="col-lg-12" style="height: 85%;background-color:white; border-radius: 6px;box-shadow: 5px">
            <form action="{{ url('/DaftarHadir') }}"  method="POST">
                @csrf
     ...
     <div class="col-lg-12" style="margin-top: 5%;margin-bottom:10% ">
        <a href="{{ url('/DaftarHadir') }}" style="color: white;font-family: 'Segoe UI';">
